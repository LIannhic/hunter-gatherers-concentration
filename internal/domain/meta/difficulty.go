...
func GetSettings(level DifficultyLevel) DifficultySettings {
	switch level {
	case LevelEasy:
		return DifficultySettings{Level: LevelEasy, PreviewDuration: 1.3, PreviewRatio: 1.0, NavThreshold: 0.5, TurnTimerDuration: 15.0, MaxSafeReveals: 3, AggressionMult: 0.5}
	case LevelNormal:
		return DifficultySettings{Level: LevelNormal, PreviewDuration: 0.8, PreviewRatio: 1.0, NavThreshold: 0.6, TurnTimerDuration: 10.0, MaxSafeReveals: 2, AggressionMult: 1.0}
	case LevelHard:
